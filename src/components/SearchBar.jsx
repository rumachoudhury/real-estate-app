...
function SearchBar() {
  ...
  //         className={`px-4 py-2 rounded-tl-lg font-semibold transition-colors duration-300 ${
  //           query.type === "buy"
  //             ? "bg-black text-white"
  ...
  //         className={`px-4 py-2 rounded-tr-lg font-semibold transition-colors duration-300 ${
  //           query.type === "rent"
  ...
  //       className="flex flex-col sm:flex-row gap-2 sm:gap-3 items-stretch justify-center bg-gray-200 p-2 "
  //     >
  //       <input
  //         type="text"
  //         name="city"
  ...
  //         className="flex-1 min-w-[120px] p-2  focus:outline-none focus:ring-2 focus:ring-blue-400"
  //       />
  ...
  //         onChange={handleChange}
  //         className="flex-1 min-w-[120px] p-2 focus:outline-none focus:ring-2 focus:ring-blue-400" //border border-gray-300
  //       />
  ...
  //         onChange={handleChange}
  //         className="flex-1 min-w-[120px] p-2 rounded focus:outline-none focus:ring-2 focus:ring-blue-400" // border border-gray-300
  //       />
  //       <Link
  ...
  //         <button
  //           type="submit"
  //           className="w-full sm:w-auto bg-yellow-500 text-white p-4 font-semibold flex  items-center gap-2 hover:bg-yellow-600 transition-colors"
  //         >
