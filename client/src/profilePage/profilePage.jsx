...
export default function ProfilePage() {
  ...
  return (
    <div className="profilePage flex flex-col lg:flex-row bg-red-100 lg:bg-gray-50 min-h-screen">
      ...
      <div className="details w-full lg:w-2/3">
        <div className="wrapper flex flex-col gap-5 p-4 sm:p-6 lg:p-8">
          ...
          <div className="title flex justify-between items-center">
            <h1 className="uppercase text-xl profile-heading opacity-0">
              User Information
            </h1>
          ...
          <div className="info flex flex-col gap-3 text-sm">
            ...
            <button
              onClick={handleLogout}
              className="w-[100px] bg-teal-300 p-1 rounded-md"
            >
              Logout
            </button>
          </div>
      ...
      {/* RIGHT SIDE CHAT */}
      <div className="chatContainer w-full lg:w-1/3 border-t lg:border-l">
        <div className="wrapper p-4 lg:p-6">
